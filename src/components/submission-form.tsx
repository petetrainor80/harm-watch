        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
          <div className="w-full max-w-xl space-y-8">
            ...
            <div className="space-y-1 text-center">
              <h1 className="text-4xl sm:text-6xl font-bold tracking-tight flex items-center justify-center gap-2 sm:gap-3">
                <TriangleAlert className="size-8 sm:size-12 shrink-0 text-[#1d70b8]" strokeWidth={2.5} />
                <span className="bg-gradient-to-r from-foreground to-[#1d70b8] bg-clip-text text-transparent whitespace-nowrap">
                  Harm Watch
                </span>
